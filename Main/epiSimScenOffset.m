...
function [Iday, Lam, Rtrue, tday, Iwarn, distvals] = epiSimScenOffset(scenNo, nday, distNo, simVals)

% Assumptions and notes
% - included a simple offset term for shifting epidemics
...
switch(distNo)
    case 1
        % Gamma distribution for COVID-19
        distvals.pm = (1/0.65)^2; distvals.omega = 6.5; 
    case 2
        % Gamma distribution for Ebola virus disease
